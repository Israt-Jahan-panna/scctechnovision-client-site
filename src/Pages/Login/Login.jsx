...
const Login = () => {
    ...
    const handleGoogleLogin = () => {
      signInWithPopup(auth, provider)
        ...
        //   // Make a POST request to your server
          fetch(
            "https://jobtask-scctechnovision-sever.vercel.app/users",
            {
              method: "POST",
              headers: {
  ...
  return (
    <div>
      <div className="font-OpenSans flex bg-white rounded-lg shadow-lg overflow-hidden mx-auto max-w-sm lg:max-w-4xl m-4">
      

        <div className="w-full p-8 lg:">
          <h2 className="text-5xl font-bold text-gray-700 text-center">
            Hi <br /> Welcome To SCC !
          </h2>
          <p className="p-4 text-center text-xl">
            Still don't have an account?{" "}
            <Link className="underline text-[#8d919d]" to={"/registration"}>
              Sign up
            </Link>
          </p>
          ...
          <div className="mt-4 flex items-center justify-between">
            ...
            <a
              href="#"
              className="text-xs text-center text-[#848996] uppercase"
            >
              or login with email
            </a>
            <span className="border-b w-1/5 lg:w-1/4"></span>
          ...
          <div className="mt-8">
            <button className="bg-slate-400 text-balck font-bold py-2 px-4 w-full rounded hover:bg-[#507184e7]">
              Login
            </button>
          </div>
          </form>
          <div className="mt-4 flex items-center justify-between">
            ...
            <a href="#" className="text-xs text-[#848996] uppercase">
